        ...
        <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group row">
                ...
                <div class="col-6">
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col">
                            <button type="submit" value="Confirmar" name="modeloEano" class="btn btn-success">Modelos e
                                Anos</button>
                        </div>
                        <div class="col">
                            <button type="submit" value="Confirmar" name="corPrata" class="btn btn-success">Cor
                                Prata</button>
                        </div>
                        <div class="col">
                            <button type="submit" value="Confirmar" name="VeiculoCorPortas"
                                class="btn btn-success">Veículos, cor e qtde portas</button>
                        </div>

                    </div>
                    <div class="row mb-3 g-3">
                        <div class="col">
                            <button type="submit" value="Confirmar" name="veiculosFord" class="btn btn-success">Veículos
                                Ford</button>
                        </div>
                        <div class="col">
                            <button type="submit" value="Confirmar" name="fabricação2013"
                                class="btn btn-success">Fabricação >= 2013</button>
                        </div>
                        <div class="col">
